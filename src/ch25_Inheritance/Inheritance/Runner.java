...
*/
    public static void main(String[] args) {
        //animal tepe class
        //eagle kendi aşına bağlanacak

        //data type obje name= new constructor name();
        ...
        Fish hamsi=new Fish();
        hamsi.izgaraBalik();
        hamsi.yeme(); //parent class dan geliyr
        ...
        //Şafak hanım
        //Bir defa parent classdan tanimlanan veri,
        // ondan sonraki extendd edilen child classlardan
        // da çekilebilir özeti bu yani dimi hoacm
    }
}
