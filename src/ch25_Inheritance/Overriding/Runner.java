...
*/
    ...
    Cat cat2=new Cat();
        ...
        System.out.println("cat2.number = " + cat2.number); // 22 cat class tan
        System.out.println("cat2.numberOfAnimals = " + cat2.numberOfAnimals); //500 animal class tan
        System.out.println("cat2.numberOfPets = " + cat2.numberOfPets);//200 pet class tan
        ...
        pet1.icme();
        pet1.beslenme();
        pet1.hareket();//pet te yok animalda var ondan gelecek
        pet1.yeme();//animal dan gelecek
