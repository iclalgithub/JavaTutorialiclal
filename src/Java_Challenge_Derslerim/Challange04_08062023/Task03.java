...
public class Task03 {
    ...
    public static void main(String[] args) {
        ...
        String str2 = "$10.55";
        System.out.println("str1'in ilk hali= " + str1);// $13.99
        str1 = str1.replaceFirst("\\D", "");
        System.out.println("str1'in $ silinmiş hali= " + str1);// 13.99

       // str1 = str1.replace("\\D", ""); //digit dışındaki herşeyi değiştir.
       // System.out.println("str1'in denediğim formatı = " + str1);
        ...
        // bu satır biraz karışık olunca hoca ayrı ayrı değişkene atayarak tekrar yazdı
