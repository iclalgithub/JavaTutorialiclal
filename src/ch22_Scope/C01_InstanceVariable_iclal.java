...
public class C01_InstanceVariable_iclal {
    /*                                  INSTANCE VARIABLE
   ...
   */
    ...
    public static void main(String[] args) {
        //   id = 21 ; Static olmadigi için static bir yerden ulaşamazsin !  .
        C01_InstanceVariable_iclal object = new C01_InstanceVariable_iclal();
        object.id = 1001 ;
        object.emekliMi = false;
        object.name = "john" ;
        object.tecrube = 23 ;
        //object.unvan = 'aa ' ; // bi tane girilebilir 2 tane girilmez ..
        object.yas = 44 ;
