...
public class C03_ListIterator {
    ...
    List <String> list2 = new ArrayList<>(Arrays.asList("offerlariniz geliyor"));
        ...
        while (listIterator2.hasNext()){
            ...
            //her bir ismi next() metodu ile ekledik
            //herbir ismi getirir ilk harfi alir gerisini yildiz ekler
            listIterator2.add(list2.toString());
           // listIterator2.add(list2);
            //böyle dersek String istiyor diye kabul etmeyecek
        }
