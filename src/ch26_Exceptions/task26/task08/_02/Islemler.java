...
public class Islemler extends Account {
        ...
        for (Account x : users) {
            if (Objects.equals(x.getName(), ad) && Objects.equals(x.getAccountNumber(), hesapNo)) {
                if (ad.equals("ali") & hesapNo.equals("0123456789")) {
                    //ali hesap numarasını yanlış girince uyarı versin ve
                    //hesap numarası girmesini istesin
                    //3 kere yanlış girince sistemden çıksın????
    ...
    public void hesapOlustur() {
        ...
        users.add(kullanici);
        System.out.println("hesabınız oluşturuldu giriş sayfasına yönlendiriliyorsunuz");
       // hesapKontrol();
        menu();
    }
