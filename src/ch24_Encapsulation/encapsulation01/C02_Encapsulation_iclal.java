...
public class C02_Encapsulation_iclal {
    /*
 ...
 */
    ...
    public C02_Encapsulation_iclal() {
    }

    public C02_Encapsulation_iclal(int id, String name) {
        this.id = id;
        this.name = name;
    }
 ...
 //   }
    ...
    public int idGerirenMethod(){
    return id;
    }


    //genelde toString en altta
    @Override
