...
public class Main_rumeysahanim {
...
class Subscribe_rumeysahanim {
    private String name;
    private boolean doYouWanaSubscribe;
    private String whichMember;
    public Subscribe_rumeysahanim() {
    }
    public Subscribe_rumeysahanim(String name, boolean doYouWanaSubscribe, String whichMember) {
        this.name = name;
