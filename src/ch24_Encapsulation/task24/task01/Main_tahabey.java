...
//            sub1.level();//p siz cont icinde cagirmadan bu sekilde de erisilebilir.

        if (sub1.isDoYouWanaSubscribe()){ //&& sub1.levelControl) {//Sub olmama durumunda Override i yazdirmamak icin.
