...
public class Main_iclal {
    public static void main(String[] args) {
        ...
        Employees_iclal employee1 = new Employees_iclal(name, salary ,dob);
...
class Employees_iclal {
    private String name;
    private int salary;
    private String dob;

    public int ageCalculator(String dob){  // date of birth -dob- 08/23/1990
       //String olarak aldığımız bir date time ı   veya local date i
        // hangisinden alırsanız günümüz yaşına çeviren - sadece integer'a çevirecek
        // yani String olarak aldığınız bir date i kendi date time objenizle çıkartıp
        // integer bir değer return eden bir kod istiyorum...

        // Sanki doğum tarihini local date type secsek yasını hesaplamak daha kolay olmaz mı
        // mustafa bey sordu hoca da bende başta böyle düşündüm ama task
        // öyle istemiyor dedi

        //08/23/1990 kullanıcı bunu String olarak girecek biz integer tipinde yaş
        //değeri output istiyoruz


        //Chat GPT
        /*Scanner scanner = new Scanner(System.in);
        System.out.print("Doğum tarihini girin (gg/aa/yyyy): ");
        String tarihStr = scanner.nextLine();

        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        LocalDate dogumTarihi = LocalDate.parse(tarihStr, formatter);
    ...
    public Employees_iclal(String name, int salary, String dob) {
        this.name = name;
        this.salary = salary;
        this.dob = dob;
    }

    public Employees_iclal() {
    }
